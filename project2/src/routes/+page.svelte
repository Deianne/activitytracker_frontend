...
<main class="container mx-auto px-4 py-6 max-w-5xl">
  <header class="mb-6">
    <h1 class="text-2xl font-medium text-gray-900">Activities</h1>
    <p class="text-gray-500 text-sm mt-1">Welcome to the homepage!</p>
  </header>
  ...
  {:else}
    <div class="relative overflow-x-auto border border-gray-200 rounded-md">
        ...
        <div class="flex justify-between items-center mb-4">
          <div class="relative">
            ...
            <input 
              ...
              class="block w-64 pl-10 pr-3 py-1.5 text-sm text-gray-900 border border-gray-300 rounded-md bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
        ...
        <thead class="text-xs font-medium text-gray-700 bg-gray-50">
          <tr>
            <th scope="col" class="p-4">
              <div class="flex items-center">
                <input id="checkbox-all-search" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-2 focus:ring-blue-500">
        ...
        <tbody>
          {#each paginatedActivities as activity (activity.id)}
            <tr class="bg-white border-b border-gray-200 hover:bg-gray-50">
              <td class="w-4 p-4">
                <div class="flex items-center">
                  <input id={`checkbox-table-${activity.id}`} type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-2 focus:ring-blue-500">
                  <label for={`checkbox-table-${activity.id}`} class="sr-only">checkbox</label>
                </div>
              </td>
              ...
              <td class="px-6 py-4 flex space-x-2">
                ...
                <button 
                  on:click={() => confirmDelete(activity.id)}
      ...
      <div class="flex justify-between items-center p-4 bg-white text-sm text-gray-600">
        <span>Showing {(currentPage - 1) * itemsPerPage + 1}-{Math.min(currentPage * itemsPerPage, filteredActivities.length)} of {filteredActivities.length} [0 row(s) selected]</span>
        <div class="flex space-x-2">
          <button 
            on:click={goToPrevPage}
            class="border border-gray-300 rounded-md px-3 py-1 hover:bg-gray-50 disabled:opacity-50" 
  ...
  {#if showDeleteModal}
    <div class="fixed inset-0 flex items-center justify-center p-4 z-50">
      <div class="bg-white rounded-md max-w-md w-full shadow-lg">
        <div class="p-4">
          <div class="flex justify-between items-center mb-3">
            <h3 class="text-lg font-medium text-gray-900">Confirm Deletion</h3>
            <button 
              on:click={() => { showDeleteModal = false; activityToDelete = null; }}
              class="text-gray-500 hover:text-gray-700"
            >
              <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12"></path>
          ...
          <div class="flex justify-end space-x-2">
            ...
            <button 
              ...
              class="bg-red-600 hover:bg-red-700 text-white rounded-md px-3 py-1.5 text-sm"
            >
              Delete
            </button>
          </div>
